    ...
    56434: (e, t, r) => {
      ...
      function S() {
        const {
          ...
          {
            algolia: { appId: t, apiKey: r, indexName: i },
          } = (0, _.L)(),
          a = (0, E.l)(),
          u = (function () {
        ...
        Q.on("result", (e) => {
          ...
          const c = (e) =>
            ...
            u = r.map((e) => {
              ...
              const i = Object.keys(r).map((e) => c(r[e].value));
              return {
                title: i.pop(),
                url: a(t),
                summary: n.content ? `${c(n.content.value)}...` : "",
                breadcrumbs: i,
              };
            });
          S({
        ...
        const [C, I] = (0, n.useState)(null),
          ...
          V = (0, b.zX)(function (t) {
            void 0 === t && (t = 0),
              ...
              Object.entries(p.searchVersions).forEach((e) => {
                let [t, r] = e;
        ...
        return (
          ...
          }, [v, p.searchVersions, V]),
          (0, n.useEffect)(() => {
            j.lastPage && 0 !== j.lastPage && V(j.lastPage);
          }, [V, j.lastPage]),
          (0, N.jsxs)(O.Z, {
            children: [
              (0, N.jsxs)(f.Z, {
                children: [
                  (0, N.jsx)("title", { children: (0, P.p)(q()) }),
                  (0, N.jsx)("meta", {
                    property: "robots",
                    ...
                    children: [
                      (0, N.jsx)("div", {
                        className: s("col", A.searchQueryColumn, {
                          "col--9": p.versioningEnabled,
                          "col--12": !p.versioningEnabled,
                        }),
                      ...
                      p.versioningEnabled &&
                        (0, N.jsx)(H, { docsSearchVersionsHelpers: p }),
                    ],
                  }),
                  (0, N.jsxs)("div", {
                    className: "row",
                    children: [
                      (0, N.jsx)("div", {
                        ...
                        children: !!j.totalResults && u(j.totalResults),
                      }),
                      (0, N.jsx)("div", {
                        className: s(
                          "col",
